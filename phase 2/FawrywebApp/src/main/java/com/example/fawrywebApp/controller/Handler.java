...
public interface Handler {
	...
	public boolean handleForm(Form form,  User user,  Service service); // Every handler should handle the Form depending on the purpose of the form but in this system
